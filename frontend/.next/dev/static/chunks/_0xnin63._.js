...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].register(email, password, fullName, userType);
            const { user, token } = response.data;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAuth"])(user, token);
...
_s(RegisterPage, "57bW0y77AoIuekvrEmJ+pS4Gc28=", false, function() {
    return [
...
//# sourceMappingURL=_0xnin63._.js.map